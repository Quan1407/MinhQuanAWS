...
# Chuẩn bị Môi trường & Thiết lập Region

### Yêu cầu tiên quyết:
1.  **Tài khoản AWS (AWS Account)** có quyền quản trị (Administrator Access) hoặc IAM Role có đầy đủ quyền thao tác trên Cognito, DynamoDB, Lambda, API Gateway, EC2, S3, CodeDeploy và IAM.
