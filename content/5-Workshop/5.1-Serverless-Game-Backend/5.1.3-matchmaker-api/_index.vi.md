...
# 5.1.3. Xây dựng Lambda Matchmaker & API Gateway REST API
...
6. **Tạo Cognito Authorizer**:
   ...
   * Đặt tên: `FightinggameCognitoAuthorizer`, chọn Type: **Cognito**, chọn User Pool `ap-southeast-1_phYoaMUPC` đã tạo ở Bước 5.1.2, nhập Token Source: `Authorization`. Nhấn **Create authorizer**.
